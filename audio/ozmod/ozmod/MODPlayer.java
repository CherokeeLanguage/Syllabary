...
public class MODPlayer extends Thread {
    ...
    public OZMod.ERR load(PipeIn _input)
    {
        ...
        for (int i = 0; i < 31; i++) {
            ...
            if (instru.lengthLoop == 0)
                ...
                instru.audio.make(pcm,  8, 1, instru.startLoop, instru.startLoop + instru.lengthLoop, AudioData.LOOP_FORWARD);
        }
    ...
    void dispatchNotes()
    {
    	...
    	for (int iVoice = 0; iVoice < nbVoices_; iVoice++) {
            ...
            switch(effect) {
               ...
               // Yes, posJump is given in BCD format. What is the interest? Absolutely none, thanks MOD..
               break;
    ...
    /**
     * Starts to play the MOD. The time latency between a note is read and then heard is approximatively of 100ms.
     * If the MOD is not loopable and finish, you cannot restart it by invoking again this method.
     */
    public void play()
    {
    ...
    /**
     * Sets the MOD loopable or not. The method can be called at any time if the song is still playing.
